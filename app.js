...
if (
      ...
      inputs.forEach((input) => {
        ...
        input.addEventListener("input", (e) => {
          ...
          if (wrapper) {
            ...
            if (name === "fullName") {
              wrapper.querySelector(".owner-name").textContent =
                liveData.fullName;
            }
            if (name === "month") {
            ...
            if (name === "year") {
              wrapper.querySelector(".exp-year").textContent =
                liveData.year.padEnd(2, "•");
            }
            if (name === "cvc") {
  ...
  */
      ...
      alert(
        "Form not present, please contact customer support. Thank you for your patience 🙏"
      );
    }
  });
}
